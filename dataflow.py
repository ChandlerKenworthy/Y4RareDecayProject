...
class Flow:
    ...
    def __init__(self, features, sim_fname, real_fname, common_features_fname='outputs/common_features', csv_path=None):
        """
    ...
    def set_sim_tree(self, tree):
        """
        Set the simulated tree prefix
        
        Parameters
        ----------
        tree : string
            The name of the decay tree to load
        """
        self.sim_tree = tree
